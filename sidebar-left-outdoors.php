                        ...
                        <div class="col-md-4">
                            <div class="sidebar">
                                <div class="search widget">
                                    <form action="<?php bloginfo('url'); ?>" method="get" class="searchform" role="search">
                                        <div class="input-group">
                                            <input type="hidden" name="sidebar" value="sidebar-left-outdoors">
                                ...
                                <div class="author widget">
                                    <img class="img-responsive" src="<?php the_field('left_editor_bg', '195'); ?>">
                                    <div class="author-body text-center">
                                        <div class="author-img">
                                            <img src="<?php the_field('left_editor_photo', '195'); ?>">
                                        </div>
                                        <div class="author-bio">
                                            <h3><?php the_field('left_editor_name', '195'); ?></h3>
                                            <p><?php the_field('left_editor_intro', '195'); ?></p>
                                        </div>
                                    </div>
                                </div>
<?php 
